...
CHECKSUM_BYTES = 2
DEFAULT_FRAME_SAMPLES = (256, 512, 736)
...
def print_report(
    ...
    print(
        ...
        "overhead  wire_Mbit/s  efficiency  UDP_fit"
    )
    for row in rows:
        print(
